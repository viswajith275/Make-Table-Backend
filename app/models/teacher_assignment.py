...
class TeacherAssignment(Base):
    ...
    role: Mapped[TeacherRole] = mapped_column(
        Enum(TeacherRole), default=TeacherRole.Subject_Teacher
    )
    morning_class_days: Mapped[Optional[List[WeekDayEnum]]] = mapped_column(
    ...
    timetable: Mapped["TimeTable"] = relationship(
        "TimeTable", back_populates="assignments"
    )  # type: ignore
